    ...
    <main className="relative min-h-screen overflow-hidden bg-[#f6faf7] text-[#111827]">
      ...
      <div className="relative mx-auto w-full max-w-6xl px-5 py-16 sm:px-8">
        ...
        <div className="mb-12 text-center">
          <p className="section-kicker">Calculadora de Economia</p>
          <h1 className="section-title mx-auto mt-4 max-w-3xl">
            Quanto custa hoje ter acesso a inteligência estratégica de alto nível?
          </h1>
          <p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-slate-600">
            Selecione os perfis que você já contrata ou gostaria de ter na sua equipe. Veja o que isso representa no orçamento, e o que a masIA oferece em comparação.
          </p>
        </div>
          ...
          {!hasSelection ? (
            <div className="flex items-center justify-center py-10 text-center">
              <p className="text-sm text-slate-400">
                ← Selecione os perfis acima para ver a comparação
              </p>
            </div>
          ) : (
            <div className="grid gap-0 sm:grid-cols-3">
              ...
              <div style={{ padding: '32px 28px', borderRight: '1px solid rgba(255,255,255,0.08)' }}>
                <p style={{ fontSize: 11, fontWeight: 700, letterSpacing: '0.12em', color: 'rgba(255,255,255,0.45)', textTransform: 'uppercase', marginBottom: 10 }}>
                  No mercado
                </p>
              ...
              <div style={{ padding: '32px 28px', borderRight: '1px solid rgba(255,255,255,0.08)', background: 'rgba(24,191,98,0.08)' }}>
                <p style={{ fontSize: 11, fontWeight: 700, letterSpacing: '0.12em', color: '#18bf62', textTransform: 'uppercase', marginBottom: 10 }}>
                  Com a masIA
                </p>
        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
          <p className="text-sm leading-7 text-slate-500">
            A masIA não é uma ferramenta qualquer. É um investimento em inteligência estratégica contínua, treinada pelo Breno Masi com a experiência real de quem construiu múltiplas empresas — por menos do que você pagaria por uma única contratação sênior.
          </p>
          <a
            href="https://ia.masinegocios.com.br/"
            className="inline-flex h-12 shrink-0 items-center justify-center rounded-full bg-[#18bf62] px-8 text-sm font-semibold text-white shadow-xl shadow-emerald-500/20 transition hover:bg-[#12a955]"
          >
